...
- `references/tool-policy-and-security.md` — posture profiles and hardening flags (deny-by-default)
- `references/plugin-ecosystem.md` — catalog-first policy; avoid installing what you don't need
- `references/authoring-plugins.md` — what a well-formed plugin looks like; calibrates reviews
- `references/failure-modes.md` — dangerous-flag symptoms to catch on audit
- `assets/audit-checklists/pre-install.md` — fast pre-install review for plugins and skills
- `assets/audit-checklists/post-install-monitoring.md` — first-72-hour monitoring after install
- `assets/audit-checklists/upgrade-audit.md` — what to re-check when a plugin upgrades
- `assets/audit-checklists/quarterly-reaudit.md` — the ongoing security cadence
- `assets/audit-checklists/incident-response.md` — when something does slip through
