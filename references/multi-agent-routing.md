...
- `references/build-tracks.md` — Track C is the multi-agent shape; each agent internally picks A or B
- `references/system-architecture.md` — the five shapes (peer / main+sub / hub-spoke / pipeline / event-driven)
- `references/subagent-design.md` — when to spawn subagents vs. separate peer agents
- `references/tool-policy-and-security.md` — per-agent posture, compartmentalization
- `references/security-audit.md` — front-to-back trust boundary review
