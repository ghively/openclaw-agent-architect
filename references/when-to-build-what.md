...
- `references/tool-creation.md` — the six paths ordered by effort; pick the lowest that fits
- `references/plugin-ecosystem.md` — catalog → ClawHub → custom ordering
- `references/authoring-skills.md` — the simplest custom path
- `references/authoring-plugins.md` — when the job genuinely warrants an SDK plugin
- `SKILL.md` — principle #7 (plugins last) and #8 (avoid reinventing) carry this philosophy
