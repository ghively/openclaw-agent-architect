...
- `references/authoring-skills.md` — the simplest path for many tool additions
- `references/authoring-plugins.md` — when a tool needs SDK integration
- `references/plugin-ecosystem.md` — catalog → ClawHub → build ordering
- `references/when-to-build-what.md` — decide whether custom is actually warranted
- `references/tool-policy-and-security.md` — the policy surface every new tool must pass through
