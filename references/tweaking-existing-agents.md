...
- `references/plan-mode.md` — the abbreviated plan-mode variant that governs tweaks
- `references/agents-md-patterns.md` — AGENTS.md edits for procedure complaints
- `references/soul-writing.md` — SOUL.md edits for voice complaints
- `references/failure-modes.md` — symptom → surface mapping catalog
- `references/operating-live-agents.md` — the broader operate-vs-migrate decision
- `assets/audit-checklists/quarterly-reaudit.md` — periodic cleanup to avoid bloat
